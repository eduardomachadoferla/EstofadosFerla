...
<body class="admin-body">
    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <section class="admin-panel" id="cadastro">
                ...
                <form class="admin-form-grid" method="post" action="salvar_produto.php" enctype="multipart/form-data" id="formProduto">
    ...
    <input type="file" id="imagem" name="imagens[]" accept="image/*" multiple required>
                    ...
                    <div class="form-actions full">
                        <div id="mensagem-erro" class="erro-msg"></div>
                            ...
                            <article class="admin-product-card">
                                ...
                                <div class="admin-product-content">
                                    ...
                                    <div class="admin-actions">
                                        ...
                                        <a class="admin-btn-delete" href="excluir_produto.php?id=<?= $produto['id'] ?>"
    ...
    <script>
        ...
        function limparErros() {
            ...
            campoImagem.classList.remove('campo-invalido');
        }
        ...
        form.addEventListener('submit', function (e) {
            ...
            if (campoDescricao.value.trim() === '') {
                campoDescricao.classList.add('campo-invalido');
                temErro = true;
            }
            ...
            if (campoImagem.files.length === 0) {
                campoImagem.classList.add('campo-invalido');
                temErro = true;
            }

            if (temErro) {
                e.preventDefault();
                mensagemErro.textContent = '⚠️ Preencha todos os campos antes de salvar o produto.';
                mensagemErro.style.display = 'block';
            }
        });

        campoCategoria.addEventListener('change', limparErros);
        campoNome.addEventListener('input', limparErros);
        campoDescricao.addEventListener('input', limparErros);
        campoPreco.addEventListener('input', limparErros);
        campoImagem.addEventListener('change', limparErros);
    </script>
