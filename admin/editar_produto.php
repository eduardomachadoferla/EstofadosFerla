    ...
    <div class="admin-layout">
        ...
        <main class="admin-main">
            ...
            <section class="admin-panel">
                ...
                <form class="admin-form-grid" method="post" action="atualizar_produto.php"
                    ...
                    <div class="form-group">
                        ...
                        <select id="categoria" name="categoria" required>
                            <option value="sofas"
                                <?= selected('sofas', mb_strtolower($produto['categoria'], 'UTF-8')) ?>>Sofás</option>
                            <option value="poltronas"
                                <?= selected('poltronas', mb_strtolower($produto['categoria'], 'UTF-8')) ?>>Poltronas
                            </option>
                            <option value="cadeiras"
                                <?= selected('cadeiras', mb_strtolower($produto['categoria'], 'UTF-8')) ?>>Cadeiras
                            </option>
                            <option value="cabeceiras"
                                <?= selected('cabeceiras', mb_strtolower($produto['categoria'], 'UTF-8')) ?>>Cabeceiras
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nome" name="nome" value="<?= htmlspecialchars($produto['nome']) ?>"
                            required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="preco" name="preco" value="<?= htmlspecialchars($produto['preco']) ?>"
                            required>
                    </div>
